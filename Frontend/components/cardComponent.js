...
class Card extends HTMLElement{
    constructor(){
        ...
        <div class="mt-3">
            <button class="btn btn-warning mx-auto" id='btnEditarPaciente' type="submit" data-bs-toggle="modal" data-bs-target="#editarInfoBasica" data-bs-toggle="modal" data-bs-target="#mdodalEditar">Editar</button>
            <button class="btn btn-danger mx-auto" id='btnEliminarPaciente' type="submit">Eliminar Paciente</button>
        </div>


        <div class="modal fade" id="mdodalEditar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="username" placeholder="@Jn23" name="username">
